...
def _has_dim_in_a_line(line):
    return all(x == 1 for x in line)
...
def has_winner(board_state):
    ...
    Args:
        board_state (dimxdim tuple of int): The current board_state we want to evaluate.

    Returns:
        int: 1 if anyone wins, 0 if noone wins
